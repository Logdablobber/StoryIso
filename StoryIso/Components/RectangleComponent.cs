...
public class RectangleComponent
{
	...
	public void Draw(SpriteBatch spriteBatch, Color color, Vector2 position, Vector2 scale)
	{
		...
		spriteBatch.FillRectangle(border_rectangle, borderColor.Value);
		spriteBatch.FillRectangle(inner_rectangle, color);
	}
}