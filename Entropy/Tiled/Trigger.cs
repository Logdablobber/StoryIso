...
public class Trigger
{
	...
	private void RunOnEnter()
	{
		...
		ScopeProcessor.RunScope(_onEnter, $"onEnter of Trigger {id}", new Source(0, null, $"onEnter of Trigger {id}"), sync: true);
	}
	...
	private void RunOnExit()
	{
		...
		ScopeProcessor.RunScope(_onExit, $"onExit of Trigger {id}", new Source(0, null, $"onExit of Trigger {id}"), sync: true);
	}
